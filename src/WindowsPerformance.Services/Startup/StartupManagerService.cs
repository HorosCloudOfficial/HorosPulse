namespace WindowsPerformance.Services.Startup;
...
public sealed class StartupManagerService : IStartupManagerService
{
    ...
    private const string DisabledSuffix = "_WindowsPerformance_Disabled";
    ...
    public StartupManagerService(ILogger<StartupManagerService> logger)
    {
        ...
        _snapshotPath = Path.Combine(
            ...
            "WindowsPerformance", "startup-entries-snapshot.json");
    }
