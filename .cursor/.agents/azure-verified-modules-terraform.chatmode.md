## azure-verified-modules-terraform.chatmode

> Quelle: ``.github\chatmodes\azure-verified-modules-terraform.chatmode.md``
> Typ: Chatmode
...
### Schwerpunkte
- Primaeres Thema: Azure AVM Terraform mode
- Geltungsbereich: Nicht spezifiziert
- Umfang der Quelle: 59 Zeilen
...
### Aktivierung
`/chatmode azure-verified-modules-terraform`
